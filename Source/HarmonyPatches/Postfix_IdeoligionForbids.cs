//Postfix for [RimWorld.RimWorld.CompAssignableToPawn_Bed.IdeoligionForbids]
using HarmonyLib;
using RimWorld;
using Verse;
...
public static class Postfix_IdeoligionForbids {
    ...
    public static void Patch(Pawn pawn, ref bool __result, ref CompAssignableToPawn_Bed __instance) {
